	...
	<table border='1'>
		...
		<s:iterator value="#request['cartlist']" id="lotteryCart">
			<tr>
				...
				<td><a
					href="<s:url action="cartDelete"><s:param name="lotteryCart.bid"><s:property value="bid"/></s:param>
                        </s:url>">删除</a>
				</td>
				<td><a
					href="<s:url action="addHistory"><s:param name="lotteryCart.bid"><s:property value="bid"/></s:param>
                        </s:url>">购买</a>
				</td>
			</tr>
		</s:iterator>
